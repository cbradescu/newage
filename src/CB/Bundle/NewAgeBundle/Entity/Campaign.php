...
class Campaign
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="CB\Bundle\NewAgeBundle\Entity\PanelView", inversedBy="campaigns")
     * @ORM\JoinTable(name="cb_newage_campaign_to_panel_view",
     *      joinColumns={@ORM\JoinColumn(name="campaign_id", referencedColumnName="id", onDelete="CASCADE")},
     *      inverseJoinColumns={@ORM\JoinColumn(name="panel_view_id", referencedColumnName="id", onDelete="CASCADE")}
     * )
     * @ConfigField(
     *      defaultValues={
     *          "merge"={
