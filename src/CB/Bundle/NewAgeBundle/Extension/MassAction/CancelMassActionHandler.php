...
class CancelMassActionHandler implements MassActionHandlerInterface
{
    /**
     * @var EntityManager
     */
    ...
    public function handle(MassActionHandlerArgs $args)
    {
        ...
        if (!array_key_exists('confirmed-items-grid', $data)) {
            throw new \InvalidArgumentException('Datagrid is missing.');
        }

        if (!array_key_exists('offer', $data['confirmed-items-grid'])) {
        ...
        $offerId = $data['confirmed-items-grid']['offer'];
