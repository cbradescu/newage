...
class ChoiceTreeLightingProvider
{
    const CLASS_NAME = 'CB\Bundle\NewAgeBundle\Entity\LightingType';
    ...
    {
        return $this->registry->getManager()->getRepository(static::CLASS_NAME)->createQueryBuilder('lt')
