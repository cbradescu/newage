...
class ChoiceTreeCityProvider
{
    const CLASS_NAME = 'CB\Bundle\NewAgeBundle\Entity\City';
    ...
    {
        return $this->registry->getManager()->getRepository(static::CLASS_NAME)->createQueryBuilder('c')
            ->select('c.id', 'c.name');
    }
}
