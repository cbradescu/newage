...
define([
    ...
    return Backbone.View.extend({
        options: {
            ...
            apiVersion: '3.exp',
            sensor: false,
            apiKey: 'AIzaSyBC4t211JSvpAUr85BtDZ76wq46sHOpHX4',
            showWeather: true
        },
        ...
        updateMap: function(address, label, lat, lng) {
            // Load google maps js
        ...
        onGoogleMapsInit: function() {
            if (!_.isUndefined(this.requestedLocation)) {
                this.updateMap(this.requestedLocation.address, this.requestedLocation.label, this.requestedLocation.lat, this.requestedLocation.lng);
