define([
    ...
    /**
     * @export  cbscheduler/js/scheduler/color-manager
     * @class   cbscheduler.scheduler.colorManager
     */
    var ColorManager = {
        /**
         * A list of background colors are used to determine colors of events of connected schedulers
         *  @property {Array}
         */
        colors: null,
        ...
        initialize: function(options) {
            ...
            this.schedulerColors = {};
        },

        setSchedulerColors: function(schedulerId, backgroundColor) {
            this.schedulerColors[schedulerId] = {
                color: this.getContrastColor(backgroundColor),
                backgroundColor: backgroundColor
            };
        },

        removeSchedulerColors: function(schedulerId) {
            if (!_.isUndefined(this.schedulerColors[schedulerId])) {
                delete this.schedulerColors[schedulerId];
            }
        },

        getSchedulerColors: function(schedulerId) {
            return this.schedulerColors[schedulerId];
        },
        ...
        _findNextColor: function(color) {
            ...
            unusedColors = _.difference(this.colors, _.pluck(this.schedulerColors, 'backgroundColor'));
