define([
    ...
    /**
     * @export  cbscheduler/js/scheduler/menu/change-scheduler-color
     * @class   cbscheduler.scheduler.menu.ChangeSchedulerColor
                ...
                try {
                    this.model.save(saveAttributes, {
                        ...
                        success: _.bind(function() {
                            ...
                            this.colorManager.setSchedulerColors(this.model.get('schedulerUid'), color);
                            this.connectionsView._actionSyncObject.resolve();
                        }, this),
                        error: _.bind(function(model, response) {
                            savingMsg.close();
                            this._showError(__('Sorry, the scheduler updating was failed'), response.responseJSON || {});
