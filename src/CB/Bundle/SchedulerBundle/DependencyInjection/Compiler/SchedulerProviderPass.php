...
namespace CB\Bundle\SchedulerBundle\DependencyInjection\Compiler;
...
class SchedulerProviderPass implements CompilerPassInterface
{
    const MANAGER_ID = 'cb_scheduler.scheduler_manager';
    const TAG_NAME   = 'cb_scheduler.scheduler_provider';
